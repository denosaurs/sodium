(function (root, denoroot, document) {
  function expose_wrappers(exports, libsodiumModule) {
    ...
    var ready = libsodiumModule.ready.then(function () {
      ...
      try {
        ...
        var nonce = exports.randombytes_buf(
          exports.crypto_secretbox_NONCEBYTES
        );
        ...
        var decrypted = exports.crypto_secretbox_open_easy(
          encrypted,
          nonce,
          key
        );
  ...
  denoroot.sodium = expose_wrappers(
    (denoroot.commonJsStrict = {}),
    denoroot.libsodium
  );
})(null, __denoroot, __document);

export default __denoroot.sodium;
